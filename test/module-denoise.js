// Contract audio-modules as audio ops — denoise family (@audio/denoise-*).
// Mirrors test/module-ops.js's header/import/wave style. Verifies restoration kernels
// wrapped per @audio/module CONTRACT host correctly through audio.use()/read(): live
...
// switch to '@audio/denoise-<atom>/audio-module' after next publish.
...
// tracked online, no manual profile argument needed — see each package's audio-module.js
...
// package's audio-module.js header for the specific reason. The host's whole-render
