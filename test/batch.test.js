...
import { compressor as amCompressor } from '../../@audio/dynamics/packages/dynamics-compressor/audio.js'
import nativeCompressor from '../../@audio/dynamics/packages/dynamics-compressor/compressor.js'
import { delay as amDelay } from '../../@audio/effect/packages/effect-delay/audio.js'
import nativeDelay from '../../@audio/effect/packages/effect-delay/delay.js'
import { highpass as amHighpass } from '../../@audio/filter/packages/filter-biquad/audio.js'
import nativeHighpass from '../../@audio/filter/packages/filter-biquad/highpass.js'
import { freeverb as amFreeverb } from '../../@audio/reverb/packages/reverb-freeverb/audio.js'
import nativeFreeverb from '../../@audio/reverb/packages/reverb-freeverb/freeverb.js'
import { isolate as amIsolate } from '../../@audio/vocals/audio.js'
import { osc as amOsc } from '../../@audio/synth/packages/synth-osc/audio.js'
import { pitch as amPitch } from '../../@audio/pitch/packages/pitch-yin/audio.js'
