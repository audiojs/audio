...
import { chorus } from '../../@audio/effect/packages/effect-chorus/audio-module.js'
import { flanger } from '../../@audio/effect/packages/effect-flanger/audio-module.js'
import { phaser } from '../../@audio/effect/packages/effect-phaser/audio-module.js'
import { tremolo } from '../../@audio/effect/packages/effect-tremolo/audio-module.js'
import { vibrato } from '../../@audio/effect/packages/effect-vibrato/audio-module.js'
import { autowah } from '../../@audio/effect/packages/effect-autowah/audio-module.js'
import { wah } from '../../@audio/effect/packages/effect-wah/audio-module.js'
import { bitcrusher } from '../../@audio/effect/packages/effect-bitcrusher/audio-module.js'
import { distortion } from '../../@audio/effect/packages/effect-distortion/audio-module.js'
import { exciter } from '../../@audio/effect/packages/effect-exciter/audio-module.js'
import { ringmod } from '../../@audio/effect/packages/effect-ringmod/audio-module.js'
import { freqshift } from '../../@audio/effect/packages/effect-freqshift/audio-module.js'
import { multitap } from '../../@audio/effect/packages/effect-multitap/audio-module.js'
import { pingpong } from '../../@audio/effect/packages/effect-pingpong/audio-module.js'
import { slew } from '../../@audio/effect/packages/effect-slew/audio-module.js'
import { noiseshaper } from '../../@audio/effect/packages/effect-noiseshaper/audio-module.js'
import { lofi } from '../../@audio/effect/packages/effect-lofi/audio-module.js'
import { graindelay } from '../../@audio/effect/packages/effect-graindelay/audio-module.js'
import { stutter } from '../../@audio/effect/packages/effect-stutter/audio-module.js'
import { subbass } from '../../@audio/effect/packages/effect-subbass/audio-module.js'
import { sbr } from '../../@audio/effect/packages/effect-sbr/audio-module.js'
