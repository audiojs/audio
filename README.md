...
* [**Creation**](#creation)
	* [new Audio(`source`, `options`?, `callback`?)]()
	* [audio.on(`event`, `callback`)]()
	* [audio.then(`success`, `failure`, `progress`)]()
...
* [**Manipulations**](#manipulations)
	* [audio.get(`from`?, `duration`?, `how`?)]()
	* [audio.set(`from`?, `what`, `how`?)]()
	* [audio.append(`data1`, `data2`, ...)]()
	* [audio.insert(`from`?, `what`, `how`?)]()
	* [audio.remove(`from`?, `duration`, `how`?)]()
	* [audio.slice(`from`?, `duration`?, `how`?)]()
	* [audio.repeat(times)]()
	* [audio.trim(`how`?)]()
	* [audio.pad(duration, `how`?)]()
	* [audio.gain(volume, `from`?, `duration`?, `how`?)]()
	* [audio.fade(`from`?, `duration`?, `how`?)]()
	* [audio.normalize(`from`?, `duration`?, `how`?)]()
	* [audio.removeDC()]()
	* [audio.threshold()]()
	* [audio.reverse(`from`?, `duration`?, `how`?)]()
	* [audio.invert(`from`?, `duration`?, `how`?)]()
	* [audio.shift()]()
	* [audio.pan()]()
	* [audio.mix()]()
	* [audio.scale()]()
